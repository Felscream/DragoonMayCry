namespace DragoonMayCry.UI.Text
{
    ...
    {
        public static string BrdModifiers =
            "- Refreshing your two DoTs with Iron Jaws before they fade on a target, or with your raid buffs active will grant you bonus points.";
        public static string HealerModifiers =
            "- Refreshing your DoT before it fades on a target will grant you bonus points.";
        ...
        public static string AstrologianModifiers =
            HealerModifiers
