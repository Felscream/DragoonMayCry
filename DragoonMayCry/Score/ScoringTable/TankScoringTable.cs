    ...
    class TankScoringTable : ScoringTable
    {
        ...
        private readonly Dictionary<StyleType, StyleScoring>
            scoringTable = new Dictionary<StyleType, StyleScoring>
            {
                ...
                { StyleType.D, new StyleScoring(50000, 3000, 4000, 1) },
                { StyleType.C, new StyleScoring(58000, 7000, 4800, 1) },
                { StyleType.B, new StyleScoring(58000, 8000, 5400, 1) },
                { StyleType.A, new StyleScoring(60000, 8000, 6000, 1) },
                { StyleType.S, new StyleScoring(60000, 10000, 6000, 0.75f) },
                { StyleType.SS, new StyleScoring(60000, 13000, 6000, 0.65f) },
                { StyleType.SSS, new StyleScoring(48000, 15000, 4800, 0.45f) },
            };
