        ...
        {
            {
                ...
                new BgmTrackData(DynamicBgmService.GetPathToAudio("DevilsNeverCry\\Chorus\\04.ogg"), 0, 23700, 24500)
            },
            {
                BgmStemIds.Chorus,
                new BgmTrackData(DynamicBgmService.GetPathToAudio("DevilsNeverCry\\Chorus\\22.ogg"), 0, 13500, 13800)
            },
            {
                BgmStemIds.Chorus2,
                new BgmTrackData(DynamicBgmService.GetPathToAudio("DevilsNeverCry\\Chorus\\16.ogg"), 0, 25630, 25800)
            },
            {
                BgmStemIds.Chorus3,
                new BgmTrackData(DynamicBgmService.GetPathToAudio("DevilsNeverCry\\Chorus\\26.ogg"), 0, 26800, 26200)
            },
            {
                BgmStemIds.ChorusTransition1,
                new BgmTrackData(DynamicBgmService.GetPathToAudio("DevilsNeverCry\\Chorus\\01.ogg"), 0, 3750, 3000)
            },
            {
                BgmStemIds.Demotion,
                new BgmTrackData(DynamicBgmService.GetPathToAudio("DevilsNeverCry\\Chorus\\05.ogg"), 0, 4510, 3000)
            },
        };
