...
namespace DragoonMayCry.Audio.StyleAnnouncer.Announcer
{
    internal class MorrisonAnnouncer : IStyleAnnouncer
    {
        private readonly Dictionary<SoundId, string> announcerFiles = new()
        {
            ...
            {
                SoundId.SmokinSexyStyle1,
                StyleAnnouncerService.GetPathToAnnouncerAudio("Morrison/stunning_sublime_style.ogg")
            },
        ...
        private readonly List<SoundId> blunderVariations = new()
            { SoundId.DeadWeight1, SoundId.DeadWeight2, SoundId.DeadWeight3, SoundId.DeadWeight4, SoundId.DeadWeight5 };
